...
void CFrame::Init(CSize CharSize, CRB2ProgDoc *pDoc)
{
    ASSERT_VALID(pDoc);
    m_pDoc = pDoc;
    m_StartAddr = 0;
...
void CByteView::Init(CSize CharSize, CRB2ProgDoc *pDoc)
{
...
void CScreen::Init(CSize CharSize, CRB2ProgDoc *pDoc, CSize size)
{
    ASSERT_VALID(pDoc);
    m_pDoc = pDoc;
    m_Size = size;
