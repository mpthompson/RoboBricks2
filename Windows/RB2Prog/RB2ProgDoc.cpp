...
IMPLEMENT_DYNCREATE(CRB2ProgDoc, CDocument)

BEGIN_MESSAGE_MAP(CRB2ProgDoc, CDocument)
...
// CRB2ProgDoc construction/destruction

const char* CRB2ProgDoc::m_strFileTypeFilter = "Binary data|*.*|Intel Hex|*.*||";

CRB2ProgDoc::CRB2ProgDoc()
...
BOOL CRB2ProgDoc::OnNewDocument()
{
...
bool CRB2ProgDoc::GetData(BYTE* pBuffer, unsigned int Length, unsigned int Start)
{
...
bool CRB2ProgDoc::SetData(BYTE* pBuffer, unsigned int Length, unsigned int Start)
{
    if (Start+Length > m_BufferLength)
    {
        ASSERT(FALSE);
...
// CRB2ProgDoc serialization

void CRB2ProgDoc::Serialize(CArchive& ar)
{
    if (ar.IsStoring())
    {
...
// CRB2ProgDoc diagnostics

#ifdef _DEBUG
void CRB2ProgDoc::AssertValid() const
{
    CDocument::AssertValid();
}

void CRB2ProgDoc::Dump(CDumpContext& dc) const
{
    CDocument::Dump(dc);
}
#endif //_DEBUG

// CRB2ProgDoc commands

BOOL CRB2ProgDoc::SaveModified()
{
...
bool CRB2ProgDoc::SaveBinary(CString FilePath)
{
    try
    {
...
bool CRB2ProgDoc::SaveIntelHexBlock(CStdioFile *pFile, ULONG Size, ULONG StartAddr)
{
...
bool CRB2ProgDoc::SaveIntelHex(CString FilePath)
{
    try
    {
...
//void CRB2ProgDoc::OnFileOpen()
//{
//  // TODO: Add your command handler code here
//}

void CRB2ProgDoc::OnFileSave()
{
    // TODO: Add your command handler code here
    SaveFile();
}

void CRB2ProgDoc::OnFileSaveAs()
{
    // TODO: Add your command handler code here
    SaveFileAs();
}

BOOL CRB2ProgDoc::OnOpenDocument(LPCTSTR lpszPathName)
{
    COpenTypeDlg dlg;
    dlg.DoModal();
...
BOOL CRB2ProgDoc::LoadFile(CString FilePath, eFileType Type)
{
...
BOOL CRB2ProgDoc::LoadBinary(CString FilePath)
{
...
BOOL CRB2ProgDoc::CalcIntelHexSize(CStdioFile* pFile, ULONG *pSize)
{
    CIntelHexRec Rec;
    CString str;
...
BOOL CRB2ProgDoc::LoadIntelHex(CString FilePath)
{
    ASSERT (m_pBuffer == NULL);
    ASSERT(m_BufferLength == 0);
    try
